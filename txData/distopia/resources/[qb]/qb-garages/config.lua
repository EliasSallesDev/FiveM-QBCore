...
Config.Garages = {
    motelgarage = {
        ...
        showBlip = true,
        blipName = 'Estacionamento publico',
        blipNumber = 357,
        blipColor = 3,
    ...
    spanishave = {
        label = 'Estacionamento Spanish Ave',
    ...
    themotorhotel = {
        label = 'Estacionamento do Motor Hotel',
    ...
    liqourparking = {
        label = 'Estacionamento da licoraria',
    ...
    haanparking = {
        label = 'Estacionamento Bell Farms',
    ...
    dumbogarage = {
        label = 'Estacionamento privado Dumbo',
    ...
    dumborigparking = {
        label = 'Estacionamento de caminhoes Dumbo',
        takeVehicle = vector3(161.23, -3188.73, 5.97),
        spawnPoint = {
            vector4(164.52, -3182.42, 6.15, 269.75)
        },
        showBlip = true,
