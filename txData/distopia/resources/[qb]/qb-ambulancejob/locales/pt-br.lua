local Translations = {
    ...
    damage = {
        melee_blunt = 'Ferimentos por pancadas / agressao fisica',
        melee_sharp = 'Ferimentos por corte / perfuracao',
        pistol = 'Ferimentos por disparos de pistola',
        smg = 'Ferimentos por rajadas de submetralhadora',
        shotgun = 'Ferimentos por disparo de escopeta',
        rifle = 'Ferimentos por disparos de fuzil',
        mg = 'Ferimentos por metralhadora',
        sniper = 'Ferimentos por disparo de sniper',
        explosive = 'Ferimentos por explosao',
        bomb = 'Ferimentos por bomba / detonacao',
        fire = 'Queimaduras',
        vehicle = 'Ferimentos por atropelamento',
        heli_crash = 'Ferimentos por queda de helicoptero',
        bleeding = 'Perda severa de sangue',
        electric = 'Ferimentos por choque eletrico',
        fall = 'Ferimentos por queda',
        animal = 'Ferimentos por ataque de animal',
        died = 'Causa indefinida',
        barbed_wire = 'Ferimentos por arame farpado',
    },
    menu = {
