local Translations = {
    ...
    damage = {
        melee_blunt = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered',
        melee_sharp = 'Knifed / Stabbed / Eviscerated',
        pistol = 'Pistoled / Blasted / Plugged / Bust a cap in',
        smg = 'Riddled / Drilled / Finished / Submachine Gunned',
        shotgun = 'Devastated / Pulverized / Shotgunned',
        rifle = 'Ended / Rifled / Shot down / Floored',
        mg = 'Machine gunned / Sprayed / Ruined',
        sniper = 'Sniped / Picked off / Scoped',
        explosive = 'Killed / Exploded / Obliterated / Destroyed / Erased / Annihilated',
        bomb = 'Bombed / Exploded / Detonated / Blew up',
        fire = 'Torched / Flambeed / Barbecued',
        vehicle = 'Flattened / Ran over / Ran down',
        heli_crash = 'Helicopter Crash',
        bleeding = 'Bled out',
        electric = 'Fried',
        fall = 'Committed suicide',
        animal = 'Mauled',
        died = 'Died',
        barbed_wire = 'Prodded',
    },
