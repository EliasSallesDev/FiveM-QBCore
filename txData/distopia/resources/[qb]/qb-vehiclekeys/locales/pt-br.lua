local Translations = {
    notify = {
        ...
        vlkeys = 'Voce emprestou a chave temporaria.',
        vborrowkeys = 'Voce recebeu uma chave emprestada temporariamente!',
    ...
    addcom = {
        ...
        lendkeys = 'Empresta temporariamente a chave do veiculo para alguem proximo. A chave nao fica salva e some ao relogar ou reiniciar.',
        lendkeys_id = 'id',
