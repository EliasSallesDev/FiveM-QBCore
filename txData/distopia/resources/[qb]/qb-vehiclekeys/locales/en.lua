local Translations = {
    notify = {
        ...
        vlkeys = 'You lend temporary keys.',
        vborrowkeys = 'You received temporary borrowed keys!',
    ...
    addcom = {
        ...
        lendkeys = 'Temporarily lend vehicle keys to someone nearby. The key is not saved and disappears after relog or restart.',
        lendkeys_id = 'id',
        lendkeys_id_help = 'Player ID',
