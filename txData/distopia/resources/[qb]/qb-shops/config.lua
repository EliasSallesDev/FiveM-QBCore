...
Config.Locations = {
    ...
    ['hardware3'] = {
        ...
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-wrench',
        ['targetLabel'] = 'Loja de ferramentas',
        ['products'] = Config.Products['hardware'],
        ['showblip'] = true,
        ['blipsprite'] = 402,
        ['blipscale'] = 0.8,
    ...
    ['weedshop'] = {
        ...
        ['targetLabel'] = 'Abrir loja de ervas',
